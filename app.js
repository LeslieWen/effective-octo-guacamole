...
//const url="http://api.weatherstack.com/current?access_key=1cf99347ca0a03c7ed40e29ec1935609&query="
...
request({url:url, json:true} ,(error, response)=>{
    if(error){
        ...
        console.log("Current condition: "+response.body.current.weather_descriptions[0])
...
//const geoURL="https://api.mapbox.com/geocoding/v5/mapbox.places/20Angeles.json?access_token=pk.eyJ1IjoiZGFya2hvdGRvZyIsImEiOiJja2QyMnZqcDUwYmZ2MnhwNTM3Zzh4b2pzIn0.4M9yfbJ5oNFaR9bWjrBikQ&limit=1"
